...
-- --------------------------------------------------
-- Date Created: 10/14/2019 21:51:28
-- Generated from EDMX file: F:\reportissue\ReportIssue\RIDataModel.edmx
-- --------------------------------------------------
...
-- Creating table 'ErrorCollections'
CREATE TABLE [dbo].[ErrorCollections] (
    [Id] nchar(256)  NOT NULL,
    [Error] varbinary(max)  NOT NULL
);
GO
...
-- Creating primary key on [Id] in table 'ErrorCollections'
ALTER TABLE [dbo].[ErrorCollections]
ADD CONSTRAINT [PK_ErrorCollections]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
